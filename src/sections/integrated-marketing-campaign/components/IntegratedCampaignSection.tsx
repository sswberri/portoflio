...
interface IntegratedCampaignSectionProps {
  projects: Project[]
}

export function IntegratedCampaignSection({ projects }: IntegratedCampaignSectionProps) {
    ...
    <section className="py-12 lg:py-20">
      ...
      <div className="mb-16 lg:mb-24">
        ...
        <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 max-w-2xl">
          Multi-channel brand awareness campaigns that deliver measurable results across all touchpoints.
        </p>
      </div>
