  ...
  'digital-commerce': [
    {
      ...
      projects: [
        {
          id: 'digital-joie',
          title: 'Joiebaby.com Digital Transformation and D2C Launch',
          description: 'Led joiebaby.com\'s global migration from WordPress to Magento 2, delivering phased multilingual rollouts across 40 countries and 23 markets. Directed cross-functional development, IT prioritization, and localization partners to ensure scalable, accurate, on-time delivery.',
          highlights: [],
          tags: ['digital transformation', 'website management', 'localization', 'resource management'],
          imageUrl: '/images/launch_GTM_joie.svg',
        },
        {
          id: 'digital-xiaomi',
          title: 'MyBug Kids Shoes Crowdfunding Campaign on Xiaomi YouPin',
          description: 'Drove the MyBug kids footwear crowdfunding launch on Xiaomi YouPin, delivering 4× sales growth in 2 weeks. Orchestrated integrated digital marketing across ads, social, search, content, and influencers, while shaping product storytelling and scaling e-commerce rollout across major marketplaces.',
          highlights: [],
          tags: ['e-commerce launch', 'digital campaign', 'performance marketing', 'social media marketing'],
